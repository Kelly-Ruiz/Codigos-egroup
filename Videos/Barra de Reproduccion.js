// ESTE CODIGO FUNCIONA PARA CREAR UNA BARRA DE PROGRESO DEL VIDEO, NO DEL CURSO
const videos = document.getElementsByTagName("video")
var video;

//IDENTIFICAR EL VIDEO QUE SE ESTA REPRODUCCIONDO PARA CREAR LA BARRA CORRESPONDIENTE
...
let baseProgreso = document.querySelector("[data-acc-text='NOMBRE_DE_ACCESIBILIDAD_BASE']");
let barraProgreso= document.querySelector("[data-acc-text='NOMBRE_DE_ACCESIBILIDAD_BARRA']");
